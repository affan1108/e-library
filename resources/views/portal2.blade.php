                ...
                <div class="col-md-2">
                    ...
                    <a href="http://dms.{{ env('SESSION_DOMAIN', 'widatra.com') }}">
                        <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 ">
                            ...
                            <span class="widget-thumb-subtitle"><b>
                                    <h3>DMS</h3>
                                </b></span>
                        </div>
                    </a>
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <div class="widget-gradient"
                                    style="background: url(../assets/layouts/layout7/img/01.jpg)">
                            ...
                            <div class="item">
                                <div class="widget-gradient"
                                    style="background: url(../assets/layouts/layout7/img/02.jpg)">
                                    <div class="widget-gradient-body">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <div class="widget-wrap-img widget-bg-color-white">
                                    ...
                                    <img class="widget-wrap-img-element img-responsive"
                                        src="{{asset('assets/layouts/layout7/img/iphone.png')}}" alt="">
                                </div>
                            </div>
                            <div class="item">
                                <div class="widget-wrap-img widget-bg-color-white">
                                    ...
                                    <img class="widget-wrap-img-element img-responsive"
                                        src="{{asset('assets/layouts/layout7/img/mac.png')}}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row widget-row">
                <div class="col-md-8 margin-bottom-20">
                    ...
                    <div class="widget-bg-color-white widget-tab">
                        ...
                        <div class="tab-content scroller" style="height: 350px;" data-always-visible="1"
                            data-handle-color="#D7DCE2">
                            <div class="tab-pane fade active in" id="tab_kategori_0">
                                @foreach (App\T_berita::where('published_at', '<=', $date_now)->orderBy('published_at',
                                    'desc')->take(10)->get() as $rr)
                                    <div class="widget-news margin-bottom-20">
                                        @if (!$rr->featured_img)
                                        <img class="widget-news-left-elem"
                                            src="{{asset('assets/global/img/no-image.jpg')}}" alt="">
                                        @else
                                        <img class="widget-news-left-elem"
                                            src="{{asset('storage/berita/'.$rr->featured_img)}}" alt="">
                                        @endif
                                        <div class="widget-news-right-body">
                                            <h3 class="widget-news-right-body-title">{{ $rr->judul }}
                                                <span
                                                    class="label label-default">{{ date('d F Y', strtotime($rr->published_at)) }}
                                                </span>
                                            </h3>
                                            <p>{{ $rr->excerpt }}</p>
                                        </div>
                            ...
                            <div class="tab-pane fade" id="{{ 'tab_kategori_'.$r->id }}">
                                @foreach (App\T_berita::where('kategori_berita_id', $r->id)->where('published_at', '<=',
                                    $date_now)->orderBy('published_at', 'desc')->take(10)->get() as $rr)
                                    <div class="widget-news margin-bottom-20">
                                        @if (!$rr->featured_img)
                                        <img class="widget-news-left-elem"
                                            src="{{asset('assets/global/img/no-image.jpg')}}" alt="">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    ...
                    <div class="portlet light tasks-widget widget-comments">
                        ...
                        <div class="portlet-body overflow-h scroller" style="height: 350px;">
                            <div class="widget-news margin-bottom-20">
                                <img class="widget-news-left-elem" src="{{asset('assets/layouts/layout7/img/03.jpg')}}"
                                    alt="">
                                <div class="widget-news-right-body">
                                    <h3 class="widget-news-right-body-title">Wondering anyone did this
                                        <span class="label label-default"> March 25 </span>
                                    </h3>
                                    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit diam nonumy nibh euismod
                            ...
                            <div class="widget-news margin-bottom-20">
                                <img class="widget-news-left-elem" src="{{asset('assets/layouts/layout7/img/04.jpg')}}"
                                    alt="">
                                <div class="widget-news-right-body">
                            ...
                            <div class="widget-news margin-bottom-20">
                                <img class="widget-news-left-elem" src="{{asset('assets/layouts/layout7/img/07.jpg')}}"
                                    alt="">
                                <div class="widget-news-right-body">
