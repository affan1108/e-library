                        ...
                        <div class="portlet-title">
                            <div class="caption">
                                @if ($mode=='create')
                                    ...
                                    <span class="caption-subject font-dark sbold uppercase">Tambah Department </span>
                                @elseif ($mode=='edit')
                        ...
                        <div class="portlet-body">
                            <form class="horizontal-form form_ajax" action="{{ $action }}" method="{{ $method }}">
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-9">
                                            <a href="{{ route('department.index') }}" class="btn dark btn-outline">Batal</a>
                ...
                <div class="col-md-6">
                    <div class="portlet light portlet-fit portlet-datatable bordered">
                        ...
                        <div class="portlet-body">
                            <dl>
                                <dt>Department</dt>
                                <dd>Masukkan Nama Department</dd>
