            ...
            <div class="portlet light portlet-fit portlet-datatable bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase">Department </span>
                        <a href="{{ route('department.create') }}" class="btn btn-xs btn-outline blue"><i class="fa fa-plus"></i> Tambah</a>
                    </div>
                    <div class="actions">
...
var TableDatatablesAjax = function () {
    ...
    grid.init({
        ...
        dataTable: {
            "ajax": {
                "url": "{{ route('department.ajax_list') }}", // ajax source
                "type": "POST",
                data: function (d) {
                    d._token        = "{{ csrf_token() }}";
