                ...
                <div class="portlet-body">
                    <form class="form-horizontal form_ajax" action="{{ $action }}" method="{{ $method }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <select class="form-control select2" name="admin_user_id">
                                        <option></option>
                                        @foreach (\App\Models\library\Library_user::where('department_id', $dt->id)->where('jabatan_id','!=',1)->where('active',1)->get() as $r)
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-9">
                                    <a href="{{ route('admin_department.index') }}" class="btn dark btn-outline">Batal</a>
