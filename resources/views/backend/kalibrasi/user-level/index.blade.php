            ...
            <div class="portlet light portlet-fit portlet-datatable bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <a href="{{ route('kalibrasi.createUserLevel') }}" class="btn btn-xs btn-outline blue"><i class="fa fa-plus"></i> Tambah</a>
                    </div>
                    <div class="actions">
...
var TableDatatablesAjax = function () {
    ...
    grid.init({
        ...
        dataTable: {
            "ajax": {
                "url": "{{ route('kalibrasi.ajaxListUserLevel') }}", // ajax source
                "type": "POST",
                data: function (d) {
                    d._token        = "{{ csrf_token() }}";
...
function btn_delete(id) {
    var url = "{{ route('kalibrasi.destroyUserLevel', ':id') }}";
