                    ...
                    <div class="portlet light portlet-fit portlet-datatable bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-dark sbold uppercase"> Tambah User DC</span>
                            </div>
                            <div class="actions">
                        ...
                        <div class="portlet-body">
                            <form class="horizontal-form form_ajax" action="{{ $action }}" method="{{ $method }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="user_id" class="form-control select2">
                                            ...
                                            @foreach ($users as $user)
                                                <option value="{{ $user->id }}">{{ $user->name }} - {{ $user->email }} - {{ $user->department->nama }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-9">
                                            <a href="{{ route('user_dc.index') }}" class="btn dark btn-outline">Batal</a>
                ...
                <div class="col-md-6">
                    <div class="portlet light portlet-fit portlet-datatable bordered">
                        ...
                        <div class="portlet-body">
                            <dl>
                                <dt>User</dt>
                                <dd>Pilih User yang akan dijadikan sebagai User DC (Document Controller) aplikasi DMS</dd>
                            </dl>
                        </div>
                    </div>
                </div>
