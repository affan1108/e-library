            ...
            <div class="portlet light portlet-fit portlet-datatable bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase">Berita </span>
                        <a href="{{ route('berita.create') }}" class="btn btn-xs btn-outline blue"><i class="fa fa-plus"></i> Tambah</a>
                    </div>
                    <div class="actions">
                    ...
                    <table class="table table-striped table-hover table-checkable dt-responsive" width="100%" id="example">
                        <thead>
                            ...
                            <tr role="row" class="filter">
                                <td></td>
                                <td>
                                    <select class="form-control form-filter" name="kategori_berita_id" style="padding:0px;width:100%">
                                ...
                                <td><input type="text" class="form-control form-filter input-sm" name="excerpt"></td>
                                <td>
...
var TableDatatablesAjax = function () {
    ...
    grid.init({
        ...
        dataTable: {
            "ajax": {
                "url": "{{ route('berita.ajax_list') }}", // ajax source
                "type": "POST",
                data: function (d) {
                    d._token        = "{{ csrf_token() }}";
                    d.kategori_berita_id = $('.filter').find('[name=kategori_berita_id]').val();
                    d.judul              = $('.filter').find('[name=judul]').val();
                    d.excerpt            = $('.filter').find('[name=excerpt]').val();
            ...
            columns: [
                ...
                { data: 'kategori_berita_nama', name: 'm_kategori_beritas.nama' },
