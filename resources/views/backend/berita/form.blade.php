                ...
                <div class="portlet-title">
                    <div class="caption">
                        @if ($mode=='create')
                            ...
                            <span class="caption-subject font-dark sbold uppercase"> Tambah Berita</span>
                        @elseif ($mode=='edit')
                            <i class="fa fa-pencil font-dark"></i>
                            <span class="caption-subject font-dark sbold uppercase"> Edit Berita</span>
                        @endif
                    </div>
                    <div class="actions">
                        ...
                        <div class="form-body">
                                ...
                                <div class="col-md-5">
                                    <select class="form-control select2" name="kategori_berita_id">
                                        ...
                                        @foreach (\App\M_kategori_berita::all() as $r)
                                            <option value="{{ $r->id }}" {{ $r->id==@$dt->kategori_berita_id ? 'selected' : '' }}>{{ $r->nama }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group ">
                                ...
                                <div class="col-md-5">
                                    ...
                                    @if ($mode=='edit')
                                        <img src="{{ asset('storage/berita/'.@$dt->featured_img) }}" width="200px" alt="">
                                        <br>
                                    @endif
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <textarea class="form-control" name="excerpt" rows="3">{{ @$dt->excerpt }}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-offset-3 col-md-9">
                                    <a href="{{ route('berita.index') }}" class="btn dark btn-outline">Batal</a>
