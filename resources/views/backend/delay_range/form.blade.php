                        ...
                        <div class="portlet-title">
                            <div class="caption">
                                @if ($mode=='create')
                                    ...
                                    <span class="caption-subject font-dark sbold uppercase"> Tambah Delay Range</span>
                                @elseif ($mode=='edit')
                                    <i class="fa fa-pencil font-dark"></i>
                                    <span class="caption-subject font-dark sbold uppercase"> Edit Delay Range</span>
                                @endif
                            </div>
                            <div class="actions">
                            ...
                            <form class="horizontal-form form_ajax" action="{{ $action }}" method="{{ $method }}">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0" class="form-control" name="min" value="{{ @$dt->min }}">
                                    </div> 
                                    <div class="form-group">
                                        <label class="control-label">Max *</label>
                                        <input type="number" min="0" class="form-control" name="max" value="{{ @$dt->max }}">
                                    </div> 
                                </div>
                                <br>
