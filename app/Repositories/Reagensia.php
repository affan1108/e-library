...
{
	private $user;
	public function __construct(\App\Models\reagensia\Reagensia_user $user)
	{
		$this->user = $user;
	}
	...
	public static function tableUserLevel($request)
	{
        ...
        $users = \App\Models\reagensia\Reagensia_user::select([
        ...
        $datatables = Datatables::of($users)
            ->addColumn('aksi', function ($r) {
                $aksi_edit = '';
                $aksi_delete = '';
                $aksi_edit = '<a href="'.route('reagensia.editUserLevel', $r->id).'" title="edit" style="color: #000;"><i class="fa fa-pencil"></i></a>';
	...
	{
		if (!$id) {
			return \App\Models\reagensia\Reagensia_user::where('active', 1)->whereNull('level_id')->get();
		}

		return \App\Models\reagensia\Reagensia_user::find($id);
	}

	public static function getLevels()
	{
		return \App\Models\reagensia\Reagensia_m_level::where('aktif', 'y')->get();
	...
	public function update($userId, $levelId)
	{
        ...
        $user = \App\Models\reagensia\Reagensia_user::find($userId);
